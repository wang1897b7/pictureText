    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (recyclerView == null) {
            ...
            mGestureDetector = new GestureDetectorCompat(recyclerView.getContext(), new
                    ItemTouchHelperGestureListener(recyclerView));
        }
                ...
                if (childClickViewIds != null && childClickViewIds.size() > 0) {
                    for (Iterator it = childClickViewIds.iterator(); it.hasNext(); ) {
                        ...
                        if (inRangeOfView(childView, e) && childView.isEnabled()) {
                            ...
                            onItemChildClick(baseQuickAdapter, childView, vh.getLayoutPosition() - baseQuickAdapter
                    ...
                    onItemClick(baseQuickAdapter, pressedView, vh.getLayoutPosition() - baseQuickAdapter
                            .getHeaderLayoutCount());
                } else {
                    setPressViewHotSpot(e, pressedView);
                    mPressedView.setPressed(true);
                ...
                if (!isHeaderOrFooterPosition(vh.getLayoutPosition())) {
                    ...
                    if (longClickViewIds != null && longClickViewIds.size() > 0) {
                        for (Iterator it = longClickViewIds.iterator(); it.hasNext(); ) {
                            ...
                            if (inRangeOfView(childView, e) && childView.isEnabled()) {
                                setPressViewHotSpot(e, childView);
                                onItemChildLongClick(baseQuickAdapter, childView, vh.getLayoutPosition() -
                    ...
                    if (!isChildLongClick) {
                        ...
                        onItemLongClick(baseQuickAdapter, mPressedView, vh.getLayoutPosition() - baseQuickAdapter
                                .getHeaderLayoutCount());
